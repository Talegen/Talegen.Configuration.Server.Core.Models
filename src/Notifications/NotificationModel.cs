...
namespace Talegen.Configuration.Server.Core.Models.Notifications
{
    ...
    public enum NotificationType
    {
        ...
        /// <summary>
        /// A notification about a given configuration.
        /// </summary>
        Configuration
    }
    ...
    public enum NotificationTarget
    {
        ...
        /// <summary>
        /// Notify all clients of a specific tenant.
        /// </summary>
        Tenant,

        /// <summary>
        /// Notify all clients. All tenants.
        /// </summary>
        All
    }
        ...
        where TTargetId : notnull
    {
        ...
        /// </summary>
        public NotificationTarget Target { get; set; } = NotificationTarget.Client;
        ...
        /// </summary>
        public TTargetId TargetId { get; set; } = default(TTargetId)!;
